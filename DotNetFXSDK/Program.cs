...
namespace DotNetFXSDK
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            eInvoice.Load(@"..\..\Data\Invoice\Simplified_Invoice.xml");
            ...
            if ((signResult != null) && signResult.IsValid)
            {
                ...
                ValidationResult ValidationResult = EInvoiceValidator.ValidateEInvoice(eInvoice, certificateContent, "NWZlY2ViNjZmZmM4NmYzOGQ5NTI3ODZjNmQ2OTZjNzljMmRiYzIzOWRkNGU5MWI0NjcyOWQ3M2EyN2ZiNTdlOQ==");
